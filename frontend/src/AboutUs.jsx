    ...
    <div className="container col-xxl-8 px-4 pt-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 pt-5">
        <div className="col-10 col-sm-8 col-lg-6">
          <img src={about} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="600" height="100" loading="lazy" />
        </div>
        <div className="col-lg-6">
          <h1 className="display-5 fw-bold lh-1 mb-3 text-light">Schaakvereniging Het Jonge Paard</h1>
          <p>
          Vestibulum congue ultricies dolor, nec semper diam efficitur non. Maecenas auctor justo dui, at rhoncus dolor finibus at. Morbi nec libero vel ipsum facilisis finibus. Nulla facilisi. Nulla turpis justo, posuere ac lacinia vel, egestas hendrerit tellus. Donec sed magna aliquam, aliquam tortor eu, sodales purus. Nunc varius pretium lectus nec cursus. 
          </p>
  ...
  <div className="container">
    <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div className="col-12 col-lg-6 col-xl-5">
        <img className="img-fluid rounded" loading="lazy" src={bg} alt="" />
      </div>
      <div className="col-12 col-lg-6 col-xl-7">
        <div className="row justify-content-xl-center">
          <div className="col-12 col-xl-11">
            <h2 className="h1 mb-3">Wie Zijn Wij?</h2>
